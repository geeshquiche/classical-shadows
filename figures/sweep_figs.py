...
axes[1].legend(fontsize=8.5, ncol=3, loc="upper center", bbox_to_anchor=(-0.12, -0.20), frameon=False)
fig.tight_layout(rect=(0, 0.08, 1, 1)); fig.savefig(_OUT + "budget_sweep.pdf"); fig.savefig(_OUT + "budget_sweep.png", dpi=150)
...
fig2.tight_layout(rect=(0, 0.08, 1, 1)); fig2.savefig(_OUT + "smoothers_ladder.pdf"); fig2.savefig(_OUT + "smoothers_ladder.png", dpi=150)
