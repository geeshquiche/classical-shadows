...
a1.set_xticklabels([t.replace("x", r"$\times$") for t in TAGS], rotation=45, ha="right", fontsize=8.5)
a1.minorticks_off()
...
a2.set_xticklabels([t.replace("x", r"$\times$") for t in TAGS], rotation=45, ha="right", fontsize=8.5)
a2.minorticks_off()
